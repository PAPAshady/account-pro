    ...
    menus: [
      {
        ...
        icon: <FaTv />,
        subLinks: [
          { id: 1, title: 'یوتیوب یک ماهه', href: '/' },
          { id: 2, title: 'یوتیوب یک ساله', href: '/' },
          { id: 3, title: 'مارول', href: '/' },
          { id: 4, title: 'نتفلیکس', href: '/' },
          { id: 5, title: 'دیزنی', href: '/' },
          { id: 6, title: 'انیمه ورلد', href: '/' },
          { id: 7, title: 'آی ام دی بی', href: '/' },
        ],
      },
      {
        id: 2,
        ...
        icon: <FaMusic />,
        subLinks: [
          { id: 1, title: 'اسپاتیفای یک ماهه', href: '/' },
          { id: 2, title: 'اسپاتیفای یک ساله', href: '/' },
          { id: 3, title: 'یوتیوب موزیک یک ماهه', href: '/' },
          { id: 4, title: 'یوتیوب موزیک یک ساله', href: '/' },
          { id: 5, title: 'ساند کلود', href: '/' },
        ],
      },
      {
        id: 3,
        ...
        icon: <FaPencilAlt />,
        subLinks: [
          { id: 1, title: 'ادوبی ایلاستریتور', href: '/' },
          { id: 2, title: 'ادوبی فوتوشاپ', href: '/' },
          { id: 3, title: 'ادوبی افترافکت', href: '/' },
          { id: 4, title: 'ادوبی پریمیر پرو', href: '/' },
          { id: 5, title: 'فیگما', href: '/' },
          { id: 6, title: 'پروکریت', href: '/' },
        ],
      },
      {
        id: 4,
        ...
        icon: <FaFoursquare />,
        subLinks: [
          { id: 1, title: 'فایرفلای', href: '/' },
          { id: 2, title: 'چت جی پی تی یک ماهه', href: '/' },
          { id: 3, title: 'چت جی پی تی یک ساله', href: '/' },
        ],
      },
      {
        id: 5,
        ...
        icon: <FaPuzzlePiece />,
        subLinks: [
          { id: 1, title: 'گیفت کارت استیم', href: '/' },
          { id: 2, title: 'گیفت کارت رایوت گیمز', href: '/' },
          { id: 3, title: 'گیفت کارت یو پلی', href: '/' },
          { id: 4, title: 'گیفت کارت بتل نت', href: '/' },
          { id: 5, title: 'گیفت کارت گوگل پلی', href: '/' },
          { id: 6, title: 'گیفت کارت اپ استور', href: '/' },
        ],
      },
    ],
  },
