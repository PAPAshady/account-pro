    ...
    <div className="flex flex-col items-center gap-3 min-[900px]:flex-row md:gap-6 lg:gap-10">
      <div className="w-full space-y-6 min-[900px]:w-1/2">
        <div className="space-y-2 font-bold">
          <h1 className="text-xl min-[900px]:text-2xl">لایسنس ویندوز ۱۱</h1>
          <p className="mb-6 text-sm min-[900px]:text-base">Windows 11 License</p>
          <p className="min-[900px]:text-lg">
            موسیقی بی وقته، دانلود نامحدود و پلی لیس هایی که همیشه در کنار تو هستن.
          </p>
          <p className="pt-3 font-bold min-[900px]:text-lg">
      ...
      <div className="relative grid w-full grid-cols-2 gap-3 min-[900px]:w-1/2">
        ...
        <div className="bg-foreground flex min-h-50 flex-col rounded-4xl rounded-tr-2xl p-5">
          <p className="space-y-2 text-[28px] font-bold min-[380px]:text-[36px] min-[420px]:text-[40px] min-[900px]:text-[32px] lg:text-[40px]">
            <span>100</span>
