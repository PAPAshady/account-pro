  ...
  return (
    <div>
      <div
        ...
        className={clsx(
          'bg-box group hover:bg-primary rounded-box-ltr flex cursor-pointer items-center justify-between px-3.75 py-3 transition-colors duration-300',
      ...
      >
        ...
        {!!numberOfActiveFilters && (
          <div
            className={clsx(
              'grid size-6 place-content-center rounded-full text-sm text-white transition-colors duration-300 group-hover:bg-[#19191955]',
              isActive ? 'bg-[#19191955]' : 'bg-[#ffffff1a]'
            )}
          >
            {numberOfActiveFilters}
          </div>
